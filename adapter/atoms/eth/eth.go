...
func (atom *EthereumAtom) GetFromAddress() string {
	return atom.key.Address.String()
}

// GetToken returns the token code of the given atom.
func (atom *EthereumAtom) GetToken() tokens.Token {
	return tokens.TokenETH
}
